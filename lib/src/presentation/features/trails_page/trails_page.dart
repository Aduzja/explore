                ...
                children: [
                  SingleChildScrollView(
                    child: StaggeredGrid.count(
                      crossAxisCount: 1,
                      mainAxisSpacing: 15,
                      children: state.trailData!.items.map((item) {
                            ...
                            child: InkWell(
                              ...
                              onTap: () {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => TrailObjectsPage(trailIndex: int.parse(item.id)),
                                  ),
                                );
                              },
                              child: Container(
                                                ...
                                                children: [
                                                  Row(
                                                    children: [
                                                      ...
                                                      const SizedBox(width: 12),
                                                      Text(
                                                        state.trailData!.totalSites.toString(),
                                                        style: GoogleFonts.roboto(
                                                          color: AppColors.white,
